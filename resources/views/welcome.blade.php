...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{url('vendors/revolution/css/layers.css')}}">
	<link rel="stylesheet" type="text/css" href="{{url('vendors/revolution/css/settings.css')}}">
	<link rel="stylesheet" type="text/css" href="{{url('vendors/revolution/css/navigation.css')}}">
...
<div id="loading-icon-bx"></div>
			...
			<div class="container">
				<div class="row d-flex justify-content-between">
					<div class="topbar-left">
						<ul>
							<li><a href="https://www.facebook.com/pages/category/Private-School/IEP-Ni%C3%B1o-Genio-181942225233691/" target="_blank"><i class="fa fa-question-circle"></i>Contacte con nosotros</a></li>
							<li><a href="javascript:;"><i class="fa fa-envelope-o"></i>mail@website.com</a></li>
						</ul>
					</div>
		...
		<div class="sticky-header navbar-expand-lg">
            <div class="menu-bar clearfix">
                <div class="container clearfix">
					<!-- Header Logo ==== -->
					<div class="menu-logo">
						<a href="{{url('/')}}"><img src="{{url('images/logo-white.png')}}" alt=""></a>
					</div>
					<!-- Mobile Nav Button ==== -->
				...
				<div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.3.0.2">
					<ul>	<!-- SLIDE  -->
						...
						data-description="Science says that Women are generally happier">
							<!-- MAIN IMAGE -->
							<img src="{{url('images/slider/slide1.jpg')}}" alt="" 
						...
						data-easeout="default" 
						data-masterspeed="default" 
						data-thumb="{{url('images/slider/slide1.jpg')}}" 
						data-rotate="0" 
						data-fstransition="fade" 
						data-fsmasterspeed="1500" 
						data-fsslotamount="7" 
						...
						data-description="Science says that Women are generally happier">
							<!-- MAIN IMAGE -->
							<img src="{{url('images/slider/slide2.jpg')}}" alt="" 
								data-bgposition="center center" 
								data-bgfit="cover" 
								data-bgrepeat="no-repeat" 
								data-bgparallax="10" 
    ...
    <footer>
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center"> <a href="{{url('/')}}">IEP niño genio</a></div>
                </div>
            </div>
        </div>
    </footer>
...
<script src="{{url('vendors/revolution/js/extensions/revolution.extension.parallax.min.js')}}"></script>
...
jQuery(document).ready(function() {
	...
	if(tpj("#rev_slider_486_1").revolution == undefined){
		...
		ttrevapi = tpj("#rev_slider_486_1").show().revolution({
			sliderType:"standard",
			jsFileLocation:"{{url('vendors/revolution/js/')}}",
